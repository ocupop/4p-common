...
var FieldHint = function FieldHint(_ref) {
  ...
  return React.createElement(
    ...
    React.createElement(semanticUiReact.Popup, {
...
var SwitchInput = function SwitchInput(_ref) {
  ...
  return React.createElement(
    'div',
    { className: 'form-group ' + className },
    React.createElement(semanticUiReact.Checkbox, _extends({}, field, { type: type, checked: field.checked, label: label, onChange: onChange, toggle: toggle })),
    hint && React.createElement(FieldHint, { content: hint })
  );
};
